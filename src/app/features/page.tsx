...
export const metadata: Metadata = {
  ...
  description:
    "Discover powerful features of Bangladesh smartest expense tracker. AI insights, Taka support, budget management, spending analytics, and more.",
  keywords: [
...
const features = [
  {
    ...
    description:
      "Get personalized financial advice and spending pattern analysis powered by advanced AI technology.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Native support for Bangladeshi currency with localized financial insights for local spending habits.",
    benefits: [
      "Local currency formatting",
      "Bangladesh-specific categories",
      "Regional spending insights",
      "Taka-optimized budgets",
    ],
  },
  {
    icon: BarChart3,
    ...
    description:
      "Comprehensive spending analytics with beautiful charts and detailed financial reports.",
    benefits: [
      "Interactive charts",
  ...
  },
  {
    ...
    description:
      "Set intelligent budgets with AI-assisted recommendations and real-time tracking.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Bank-grade security with end-to-end encryption to keep your financial data safe.",
    benefits: [
      "256-bit encryption",
  ...
  },
  {
    ...
    description:
      "Responsive design optimized for mobile devices with PWA support for app-like experience.",
    benefits: [
      "Progressive Web App",
      "Offline support",
      "Touch-optimized",
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <section className="container mx-auto px-4 py-12 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Discover how our AI-powered expense tracker helps thousands of
            Bangladeshis take control of their finances with intelligent
            insights and local currency support.
          </p>
