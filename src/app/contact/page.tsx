...
export const metadata: Metadata = {
  ...
  description: 'Contact AI Expense Tracker Bangladesh for support, feedback, or inquiries. We are here to help you with your financial tracking needs. 24/7 customer support available.',
  keywords: [
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes, you can export your expense data in CSV or PDF format from the dashboard analytics section.'
  },
  {
    question: 'How does the AI generate insights?',
    answer: 'Our AI analyzes your spending patterns, compares them with similar user profiles, and provides personalized recommendations based on your financial goals.'
  }
];
...
export default function ContactPage() {
  const breadcrumbs = [
    ...
    { name: 'Contact Us', url: 'https://costing-tracker-cxoiu1yv6-sakibs-project.vercel.app/contact' }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <section className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            We are here to help you make the most of your expense tracking experience. 
        ...
        <section className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of Bangladeshis who are already managing their finances smarter with our AI-powered platform.
          </p>
          <Link href="/">
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  <li><a href="mailto:support@expensetracker.bd" className="hover:text-white">Email Support</a></li>
                  <li><a href="tel:+8801700000000" className="hover:text-white">Phone Support</a></li>
