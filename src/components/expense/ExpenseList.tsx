  ...
  return (
    <div className="space-y-3">
      {expenses.map((expense) => (
        <div key={expense._id} className="flex items-center justify-between p-3 border rounded-lg bg-white hover:bg-gray-50 transition-colors">
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-600">
              ...
              {expense.note && (
                <p className="mt-1 text-xs text-gray-500 truncate">{expense.note}</p>
              )}
            </div>
          </div>
